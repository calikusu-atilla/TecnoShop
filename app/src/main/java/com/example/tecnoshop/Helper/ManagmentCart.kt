...
import com.example.tecnoshop.Helper.TinyDB
...
class ManagmentCart(val context: Context) {
    ...
    fun plusItem(listItmes: ArrayList<ItemsModel>, position: Int, listener: ChangeNumberItemsListener) {
        listItmes[position].numberInCart++
        tinyDB.putListObject("CartList", listItmes)
        listener.onChanged()
    }
